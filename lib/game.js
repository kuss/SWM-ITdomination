	...
	for (var player_i in this.players) {
		for (var card in players[player_i].front_field) {
			for (var i in players[player_i].front_field[card].proto.effects) {
				if (players[player_i].front_field[card].proto.effects[i].condition(players[player_i].state, game, players[player_i])) {
					players[player_i].front_field[card].proto.effects[i].affect(players[player_i].state, game, players[player_i]);
				}
			}
		}
	}
