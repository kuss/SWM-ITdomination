...
Game.prototype.turnStart = function (player) { //턴 시작! 
	...
	this.applyEffects();
		as currently not installed.  To run 'sdf' please ask your administrator to install the package 'sdf'
		ast-forwards
	this.sendScreen();
...
Game.prototype.applyEffects = function () {
	...
	for (var player in this.players) {
		player.moneyPerTurn = Constant.game.moneyPerTurn;
	}
	// 시제품 카드 기본 설정 
	for (var player in this.players) {
	...
	// market카드 기본 설정
	market.vit = market.proto.vit;
	market.occ = market.proto.occ;
