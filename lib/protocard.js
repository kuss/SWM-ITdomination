			...
			new Effect({
				...
				,condition : function (card, game, player) {
					return (
									...
									|| (
										((EffectUtil.whenCardExistbyNameinMarket("Omina 1"))(card, game, player))
			...
			new Effect ({
				...
				,condition : function (card, game, player) {
					return (
									...
									|| (
										((EffectUtil.whenCardExistbyNameinMarket("Omina 2"))(card, game, player))
										&& ((EffectUtil.whenPlayerHaveMarket())(card, game, player))
										)
								);
				}
			...
			new Effect({
				...
				,condition : function (card, game, player) {
					return (
									...
									|| (
										((EffectUtil.whenCardExistbyNameinMarket("이건희 LV100"))(card, game, player))
										&& ((EffectUtil.whenPlayerHaveMarket())(card, game, player))
										)
								);
				}
	...
	},
	{
		...
		,effects : [
			new Effect({
				...
				,condition : function (card,game,player) {
					return (
									((EffectUtil.whenCardExistbyNameinFrontField("김연아"))(card, game, player))
									|| (
										((EffectUtil.whenCardExistbyNameinMarket("김연아"))(card, game, player))
										&& ((EffectUtil.whenPlayerHaveMarket())(card, game, player))
										)
								);
				}
			...
			new Effect({
				...
				,condition : function (card, game, player) {
					return (
									...
									|| (
										((EffectUtil.whenCardExistbyNameinMarket("이재용"))(card, game, player))
										&& ((EffectUtil.whenPlayerHaveMarket())(card, game, player))
										)
								);
				}
			...
			new Effect({
				...
				,condition : function (card, game, player) {
					return (
									...
									|| (
										((EffectUtil.whenCardExistbyNameinMarket("D-RAM"))(card, game, player))
										&& ((EffectUtil.whenPlayerHaveMarket())(card, game, player))
										)
								);
				}
				,affect : function (card, game, player) {
					(EffectUtil.increaseOtherCardAttackbyValueinFrontField(null, -300))(card, game, player);
				}
			})
		]
	},
	...
	},
	{
		...
		,effects : [
			new Effect({
				...
				,affect : function (card, game, player) {
					(EffectUtil.increaseMoneyPerTurnbyValue(50)(card, game, player));
				}
			})
		]	
	},
	{
		...
		,effects : [
			new Effect({
				...
				,condition : function (card, game, player) {
					return (
									(EffectUtil.whenCardExistbyNameinBackField("AMOLED"))(card, game, player)
								);
	...
	},
	{
		...
		,effects : [
			new Effect({
				...
				,condition : function (card, game, player) {
					return (
							(EffectUtil.whenCardExistbyNameinBackField("Wheel-Chair"))(card, game, player) &&
							(player.gameState === Constant.gameState.turnStart) &&
							((EffectUtil.whenPlayerHaveMarket())(card, game, player)) &&
							((EffectUtil.whenCardExistbyNameinMarket("이건희"))(card,game,player))
						);
				...
				,affect : function (card, game, player) {
					(EffectUtil.increaseVitbyValue(500))(card, game, player);
				}
			})
		]
	},
	/* 이하 삼성 전략카드 */
	{
		...
		,effects : [
			new Effect({
				...
				,condition : function (card, game, player) {
					return (
						(EffectUtil.whenCardExistbyNameinBackField("경영 승계"))(card, game, player) &&
						(!(EffectUtil.whenCardExistbyNameinDeck("이건희"))(card, game, player))
					);
				}
				,affect : function (card, game, player) {
					(EffectUtil.getCardfromDeck("이재용"))(card, game, player);
					(EffectUtil.removeCardfromBackField("경영 승계"))(card, game, player);
				}
			})
			,new Effect({
				continueTrun : Constant.game.maxTurn
	...
	},
	{
		...
		,effects : [
			new Effect({
				...
				,condition : function (card, game, player) {
					return (
						(EffectUtil.whenCardExistbyNameinBackField("언론 플레이"))(card, game, player)
					);
				}
				,affect : function (card, game, player) {
	...
	},
	{
		...
		,effects : [
			new Effect({
				...
				,condition : function (card, game, player) {
					return (
						(EffectUtil.whenCardExistbyNameinBackField("디자인 카피"))(card, game, player)
					);
				}
				,affect : function (card, game, player) {
